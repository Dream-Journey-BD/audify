        ...
        {isExporting ? (
          <div className="p-6 sm:p-8 flex flex-col items-center justify-center space-y-6 flex-1 text-center">
            ...
            <div className="relative flex items-center justify-center">
              <div className="w-20 h-20 rounded-2xl bg-violet-500/10 border border-violet-500/30 flex items-center justify-center text-violet-400">
                <Loader2 className="w-10 h-10 animate-spin text-violet-400" />
              </div>
              <div className="absolute -bottom-2 px-2.5 py-0.5 rounded-full bg-violet-600 text-white text-[10px] font-bold tracking-wider uppercase font-mono shadow-md">
            ...
            <div className="space-y-1.5 max-w-sm">
              <h4 className="text-base font-bold text-neutral-100">
                Exporting & Encoding Files...
              </h4>
              <p className="text-xs text-neutral-400">
                Applying LUFS normalization and rendering files. Please wait while the batch is being packaged.
              </p>
            </div>
