...
/**
 * Converts AudioBuffer to 16-bit PCM WAV Blob (synchronous version)
 */
...
/**
 * Converts AudioBuffer to 16-bit PCM WAV Blob asynchronously with non-blocking time-slices
 */
export async function audioBufferToWavBlobAsync(
  buffer: AudioBuffer,
